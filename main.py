...
if page=='About':
    ...
    st.write(
        'We approached this project to learn about the Core Concept of the Deep learning environment Under the Guidance : Dr. Rohit Gupta Sir . With this in mind,first we learned about different datasets and algorithms of deeplearning. For Better User Interface experience and designs we taken help from Streamlit which is open source app framework in Python language.'
    )
    st.subheader('Aim')
