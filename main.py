...
st.sidebar.title("Disease Prediction and Diagnostic Analysis Using Deep Learning")
...
if page=='About':
    ...
    st.write(
        'We approached this project to learn about the Core Concept of the Deep learning environment Under the Guidance : Dr. Rohit Gupta Sir . With this in mind,first we learned about different datasets and algorithms of deeplearning.'
        'I would like to say that Machine Learning has inspired me for doing great things by learning about great things this project is one of my starters project in this domain and with it I am able to experience not only life of an Enginner but a Physican as well.'
